...
<form name ="myform"action="insert.php"class="w3-container w3-display-middle w3-card-4 w3-center w3-white w3-text-brown w3-margin" style="width:900px;height:450px">
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-book"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="subject" type="text"  value="<?php echo $_POST["subject"]; ?> "readonly >
    </div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-calendar"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="date" type="date" value="<?php echo $_POST["date"]; ?>" readonly>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-clock-o"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="time" type="time"  value="<?php echo $_POST["time"]; ?>" readonly>
    </div>
</div>
<div class="w3-section">
<button class="w3-button  w3-win8-olive w3-ripple" formaction="resulttt.php" name= "b"> Go Back </button>
<button class="w3-button w3-section w3-win8-olive w3-ripple" id="book"name= "s"> Book Now </button>
...
$(document).ready(function(){
  ...
  if (s == "") {
    alert("please insert the required information");
    return false;
  }
...
alert("Your appoinment have been confirmed!");
});
});
</script>
